...
//                       className='bg-slate-800 text-white rounded-lg uppercase hover:opacity-85 p-2 sm:p-3 w-full mx-auto text-center mt-3 text-[13px] sm:text-[16px]'
//                     >
//                       Contact Owner
//                     </button>
//                   )}
...
import './custom-swiper-styles.css'; // Import custom CSS if using external file
...
export default function ViewCar() {
  ...
  return (
    <main className='max-w-[1200px] mx-auto p-2 h-full shadow-md shadow-gray-900 mt-4'>
      <div className='grid grid-cols-1 md:grid-cols-2'>
        <div className='mt-5 relative'> {/* Add relative positioning */}
          <Swiper
            navigation={{
          ...
          <div className='custom-swiper-button-prev'>
            <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-800" viewBox="0 0 24 24"><path d="M15 18l-6-6 6-6" /></svg>
          </div>
          <div className='custom-swiper-button-next'>
            <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-800" viewBox="0 0 24 24"><path d="M9 18l6-6-6-6" /></svg>
          </div>
